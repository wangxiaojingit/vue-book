...
export const mutations={
      ...
      //改变购物车的数量
      [Types.CHANGECARTTOTAL](state){
            debugger;
         let total= state.cartData.reduce(function(pre,current,index){
               return pre+current.num;
         },0);
         state.total=total;
      },
      //修改购物车的状态
      [Types.CARTFLAG](state){
            debugger;
          state.cartflag=state.cartData.length?true:false;
      },
      //修改购物车中单个商品的数量
